			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="text-muted-foreground mt-6 text-pretty text-lg leading-8">
						Join our exclusive waitlist and get early access to the platform that will
						transform how you build software. Plus, receive a special launch discount
						when we go live.
					</p>
				</div>
						...
						<CardContent>
							{isSubscribed ? (
								...
								>
									...
									<Button
										type="submit"
										className="bg-primary hover:bg-primary/90 text-primary-foreground h-12 w-full text-base font-semibold"
									...
									<p className="text-muted-foreground text-center text-xs">
										By joining, you agree to receive updates about our platform. We
										respect your privacy and will never spam you.
									</p>
				...
				<div className="mx-auto mt-16 max-w-4xl">
					<div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
						<div className="text-center">
							...
							<div className="text-muted-foreground text-sm">Developers waiting</div>
						</div>
						<div className="text-center">
							<div className="text-primary text-3xl font-bold">100%</div>
							<div className="text-muted-foreground text-sm">Launch discount</div>
						</div>
						<div className="text-center">
							<div className="text-primary text-3xl font-bold">Q1 2026</div>
							<div className="text-muted-foreground text-sm">Expected launch</div>
						</div>
					</div>
				</div>
			</div>
